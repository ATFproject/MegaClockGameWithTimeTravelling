...
#ifndef MEGACLOCKGAMEWITHTIMETRAVELLING_SMARTENUM_HPP
#define MEGACLOCKGAMEWITHTIMETRAVELLING_SMARTENUM_HPP
...
#define smart_enum_class(Type, ...) enum class Type { __VA_ARGS__}; \
    ...
    { \
        return Type##_enum_names.at(static_cast<int32_t>(value));\
    } \
    \
    ...
    \
    inline Type Type##_to_enum_class(const std::string& name)\
    {\
        return static_cast<Type>(Type##_enum_values.at(name));\
    }

#endif //MEGACLOCKGAMEWITHTIMETRAVELLING_SMARTENUM_HPP
